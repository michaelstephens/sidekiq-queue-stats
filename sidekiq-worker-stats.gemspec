# -*- encoding: utf-8 -*-
require File.expand_path('../lib/sidekiq/worker_stats/version', __FILE__)
...
Gem::Specification.new do |gem|
  ...
  gem.homepage      = "https://github.com/mikestephens/sidekiq-worker-stats/"

  gem.files         = `git ls-files`.split($\)
  gem.executables   = gem.files.grep(%r{^bin/}).map{ |f| File.basename(f) }
  gem.test_files    = gem.files.grep(%r{^(test|spec|features)/})
  gem.name          = "sidekiq-worker-stats"
  gem.require_paths = ["lib"]
  gem.version       = Sidekiq::WorkerStats::VERSION
